...
logger = logging.getLogger("dream11_repo")


async def insert_dream11_projections_async(data_list):
    if len(data_list) == 0:
        return
    ...
    sql = """
    INSERT INTO dream11_projections (
    ...
    ON DUPLICATE KEY UPDATE
        ...
        updated_at = NOW()
    """
    return await execute_chunked(sql, values, label="[dream11_projections]")
