...
logger = logging.getLogger("draftkings_repo")


async def insert_draftkings_projections_async(data_list):
    if len(data_list) == 0:
        return
    ...
    sql = """
    INSERT INTO draftkings_projections (
    ...
    ON DUPLICATE KEY UPDATE
        ...
        updated_at = NOW()
    """
    return await execute_chunked(sql, values, label="[draftkings_projections]")
