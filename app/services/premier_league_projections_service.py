        ...
        for i in range(len(previous_accuracy_fixtures)):
            ...
            for stat in stat_list:
                ...
                if stat == 'Goals':
                    ...
                    # Write outcome flags as integers (1/0) for consistency
                    # with the numeric-from-DB column dtype — mixed 'Y'/'N'
                    # strings break parquet write. See projection_service
                    # line 325 for full context.
                    for ds in [projection_accuracy_dataset_league, projection_accuracy_dataset_all]:
